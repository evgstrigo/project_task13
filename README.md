...
- с помощью системы логирования `log4j`, необходимо логировать ошибки, которые могут вылетать в контроллере. Но про другие ошибки тоже не забывайте.
Для создания объекта логгера необходимо над классом написать аннотацию @Log4j2.
...
Созвоны проходят по понедельникам, средам и пятницам в 17:30.
Регламент:
